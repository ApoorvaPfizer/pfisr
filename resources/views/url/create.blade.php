    ...
    <div class="col-10 col-md-8 col-lg-6">
      ...
      <form action="{{ route('url.store') }}" method="post">
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control" id="optional_alias" name="optional_alias">
        </div>
        <div class="form-group">
          <label for="exipration_date">Expiration date</label>
          <input type="date" class="form-control" id="exipration_date" name="exipration_date">
        </div>
        <div class="form-group">
          <label for="link_redirection">Expired link redirection</label>
          <input type="text" class="form-control" id="link_redirection" name="link_redirection">
        </div>
        <div class="form-group">
